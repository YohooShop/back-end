...
import com.yoooho.mall.dao.UmsAdminPermissionRelationDao;
import com.yoooho.mall.dao.UmsAdminRoleRelationDao;
import com.yoooho.mall.dto.UmsAdminParam;
import com.yoooho.mall.dto.UpdateAdminPasswordParam;
import com.yoooho.mall.mapper.UmsAdminLoginLogMapper;
import com.yoooho.mall.mapper.UmsAdminMapper;
import com.yoooho.mall.mapper.UmsAdminPermissionRelationMapper;
import com.yoooho.mall.mapper.UmsAdminRoleRelationMapper;
...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    public UmsAdmin getCurrentAdmin() {
        ...
        return adminMapper.selectByPrimaryKey(adminUserDetails.getId());
    }
    ...
    public String login(String username, String password) {
        ...
        try {
//            UmsAdmin umsAdmin = new UmsAdmin();
            String encodePassword = passwordEncoder.encode("888888");
//            umsAdmin.setPassword(encodePassword);
//            umsAdmin.setId((long) 3);
...
//            updateLoginTimeByUsername(username);
    ...
    public int updateRole(Long adminId, List<Long> roleIds) {
        ...
        adminRoleRelationExample.createCriteria().andUserIdEqualTo(adminId);
