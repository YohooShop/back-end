...
import com.yoooho.mall.dto.PmsProductParam;
...
public class PmsProductController {
    ...
    @ResponseBody
    public CommonResult<PmsProduct> getinfo(@PathVariable Long id) {
        PmsProduct productResult = productService.getInfo(id);
