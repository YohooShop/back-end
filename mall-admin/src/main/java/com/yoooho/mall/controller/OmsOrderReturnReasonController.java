...
import com.yoooho.mall.model.OmsOrderReturnReason;
import com.yoooho.mall.service.OmsOrderReturnReasonService;
...
public class OmsOrderReturnReasonController {
    ...
    @PreAuthorize("hasAuthority('oms:returnReason:create')")
    @ResponseBody
    ...
    @PreAuthorize("hasAuthority('oms:returnReason:update')")
    @ResponseBody
    ...
    @PreAuthorize("hasAuthority('oms:returnReason:del')")
    @ResponseBody
