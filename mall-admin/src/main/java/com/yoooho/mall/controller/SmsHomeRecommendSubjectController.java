...
public class SmsHomeRecommendSubjectController {
    ...
    @PreAuthorize("hasAuthority('sms:recommendSubject:create')")
    @ResponseBody
    ...
    @PreAuthorize("hasAuthority('sms:recommendSubject:update')")
    @ResponseBody
    ...
    @PreAuthorize("hasAuthority('sms:recommendSubject:del')")
    @ResponseBody
