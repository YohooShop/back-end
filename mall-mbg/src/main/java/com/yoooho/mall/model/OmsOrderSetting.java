...
public class OmsOrderSetting implements Serializable {
    ...
    @ApiModelProperty(value = "拼团订单超时关闭时间(分)")
    private Integer pinkOrderOvertime;

    @ApiModelProperty(value = "拼团订单未完成超时")
    private Integer pinkDoneOvertime;

    @ApiModelProperty(value = "拼团有效时间")
    private Integer pinkEffectOvertime;
    ...
    public Integer getPinkOrderOvertime() {
        return pinkOrderOvertime;
    }

    public void setPinkOrderOvertime(Integer pinkOrderOvertime) {
        this.pinkOrderOvertime = pinkOrderOvertime;
    }

    public Integer getPinkDoneOvertime() {
        return pinkDoneOvertime;
    }

    public void setPinkDoneOvertime(Integer pinkDoneOvertime) {
        this.pinkDoneOvertime = pinkDoneOvertime;
    }

    public Integer getPinkEffectOvertime() {
        return pinkEffectOvertime;
    }

    public void setPinkEffectOvertime(Integer pinkEffectOvertime) {
        this.pinkEffectOvertime = pinkEffectOvertime;
    }
    ...
    public String toString() {
        ...
        sb.append(", pinkOrderOvertime=").append(pinkOrderOvertime);
        sb.append(", pinkDoneOvertime=").append(pinkDoneOvertime);
        sb.append(", pinkEffectOvertime=").append(pinkEffectOvertime);
