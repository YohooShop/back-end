...
import com.yoooho.mall.common.exception.EntityNotFoundException;
...
import com.yoooho.mall.repository.UserAvatarRepository;
import com.yoooho.mall.repository.UserRepository;
import com.yoooho.mall.service.convern.UserMapper;
...
//        }
    ...
    public void download(List<UserDTO> queryAll, HttpServletResponse response) throws IOException {
        ...
        for (UserDTO userDTO : queryAll) {
            ...
            map.put("最后修改密码的时间", sdf.format(userDTO.getLastPasswordResetTime()));
            map.put("创建日期",sdf.format(userDTO.getCreateTime()));
            list.add(map);
        }
