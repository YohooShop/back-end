...
public class UmsMemberCouponController {
    ...
    @ResponseBody
    public CommonResult<List<SmsCouponHistoryDetail>> list(@RequestParam(value = "useStatus", required = false) Integer useStatus,
            @RequestParam(value = "pages") Integer pages, @RequestParam(value = "size") Integer size) {
        List<SmsCouponHistoryDetail> couponHistoryList = memberCouponService.list(useStatus, pages, size);
    ...
    @ResponseBody
    public CommonResult<List<SmsCouponHistoryDetail>> listCart(@PathVariable Integer type, @RequestParam("ids")List<Long> ids) {
    ...
    @ApiOperation("获取用户可领优惠券列表")
    @RequestMapping(value = "/couponList", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult couponList(){
        return memberCouponService.couponList();
    }
