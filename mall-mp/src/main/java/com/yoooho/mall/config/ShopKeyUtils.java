...
import com.yoooho.mall.common.constant.SystemConfigConstants;
...
public class ShopKeyUtils {
    ...
    public static  String getYshopWeiXinMpSevice(){
        String yshopWeiXinMpSevice= ShopConstants.YOOOHOSHOP_WEIXIN_MP_SERVICE;
    ...
    public static  String getYshopWeiXinPayService(){
        String yshopWeiXinPayService= ShopConstants.YOOOHOSHOP_WEIXIN_PAY_SERVICE;
    ...
    public static  String getYshopWeiXinMiniPayService(){
        String yshopWeiXinMiniPayService= ShopConstants.YOOOHOSHOP_WEIXIN_MINI_PAY_SERVICE;
    ...
    public static  String getYshopWeiXinAppPayService(){
        String yshopWeiXinAppPayService= ShopConstants.YOOOHOSHOP_WEIXIN_APP_PAY_SERVICE;
